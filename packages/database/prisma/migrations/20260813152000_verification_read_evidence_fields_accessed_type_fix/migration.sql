-- Canonical forward fix:
-- verification.read_evidence data_access_logs.fields_accessed
-- is text[]; historical function supplied jsonb and raised SQLSTATE 42804.
-- Historical migration bytes remain immutable.
